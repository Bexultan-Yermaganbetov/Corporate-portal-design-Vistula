...
function changeAnimalSurname() {
    ...
    changeMusic(); // Change music based on the new animal
}

function changeAnimalRandomSurname() {
...
function changeMusic() {
    ...
    document.getElementById("myMusicSurname").src = music;
    document.getElementById("musicSurname").load();
